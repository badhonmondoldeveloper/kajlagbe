...
const TITLE_TEMPLATES: Record<string, string[]> = {
  'ac-repair': [
    '২টি স্প্লিট এসির ডিপ ওয়াশ ও গ্যাস রিফিল সার্ভিসিং প্রয়োজন',
    'এসি ঠান্ডা কম হচ্ছে, প্রেসার চেক ও গ্যাস লিক ফিক্স',
    'নতুন ১.৫ টন স্প্লিট এসি ইনস্টলেশন ও মাস্টার ড্রিলিং',
  ],
  'electrician': [
    'বাসার সম্পূর্ণ ইলেকট্রিক ওয়্যারিং ও মেইন সুইচ ফিক্স',
    '৩টি ফ্যান ও সিলিং লাইট পয়েন্ট ইনস্টলেশন',
    'শর্ট সার্কিট ট্রাবলশুটিং ও সার্কিট ব্রেকার চেঞ্জ',
  ],
  'plumbing': [
    'বাথরুমের পানির পাইপ লিক ও শাওয়ার মোটর মেরামত',
    'নতুন কমোড ও বেসিন ফিটিং ইনস্টলেশন',
    'পানির পাম্প সার্ভিসিং ও ওভারফ্লো লাইন ফিক্স',
  ],
  'home-cleaning': [
    '৩ বেডরুম ফ্ল্যাটের ডিপ ফুল হাউস ক্লিনিং সার্ভিস',
    'সোফা ও কার্পেট শ্যাম্পু ডিপ ওয়াশ',
    'রান্নাঘর ও বাথরুম টাইলস ডিপ ওয়াশ',
  ],
  'appliance-repair': [
    'রেফ্রিজারেন্ট ও ডিপ ফ্রিজ গ্যাস রিফিল সার্ভিস',
    'ওয়াশিং মেশিন ড্রাম মোটর ও ড্রেন ওয়াটার ফিক্স',
    'মাইক্রোওভেন হিটিং সমস্যা ও পিসিবি বোর্ড রিপেয়ার',
  ],
};
